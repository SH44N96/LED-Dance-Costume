...
int tls[] = {69, 68, 67, 66, 65, 64, 63, 62, 61, 60, 59, 58, 57, 56, 55, 54, 53, 52, 51, 50, 49, 48, 47, 46, 45, 44, 43, 42};
...
void loop()
{
  ...
  if(btnState == LOW)
  {
    if(tracker == 1)
    {
      ...
      // Play Music
      CylonShoulder(0, 0, 150, 2, 15); // 688ms
      ...
      colorWipe(200, 200, 200, 30); // 650ms
